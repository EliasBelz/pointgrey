...
import FloatingNav from "@/components/ScrollToTop";
...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: "Everything you want to know about Point Grey Pictures.",
    images: [
      "https://github.com/EliasBelz/pointgrey/blob/aae2849e19afce16dea3eb8fdd471947a025a8cf/public/og-logo.jpg?raw=true",
    ],
  },
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`no-scroll-bar bg-secondary min-h-screen flex flex-col ${markazi.variable} ${outfit.variable} ${pet.variable} ${aleo.variable} ${pet.variable} ${anybody.variable}`}
      >
